...
[My journey in web3sec](https://www.cyfrin.io/success-stories/from-devops-engineer-to-codehawks-eagle).
...
| InceptionVaults II| 2025-05  | LST / LRT                  | **[Report](https://github.com/bailsec/BailSec/blob/main/Bailsec%20-%20InceptionLRT%20-%20Vaults%20-%20Final%20Report.pdf)** |
...
| MorphL2             | L2 Bridge / Staking               | **[5th 🎖️](https://audits.sherlock.xyz/contests/207/leaderboard)** |
...
All Public Engagements are listed on my [Sherlock Profile](https://audits.sherlock.xyz/watson/0xStalin)
...
- [🔴 High - Tetris - Stale claim of a requestRedemeption from an older epoch prior to the migration of an insolvent silo enable to underflow totalRedeemTrueSiloShares, permanently DoSing redeemers]()
- [🔴 High - Tetris - Fee accrual, permissionless dust-deposit, fresh-vault/existing-silo PPS mismatch, or deposit-triggered profit withdrawal inflates totalSupply above ownedSyncSiloShares, causing permanent fullMulDiv overflow DoS in Vault::mint and Vault::maxMint]()
- [🔴 High - Tetris - New vaults can be permanently DoS by bootstraping a dust-deposit forcing the Vault to fall in insolvent state]()
...
## Perpetuals
- [🔴 High - Panoptic - `SettleLongPremium` is incorrectly implemented: premium should be deducted instead of added](https://solodit.cyfrin.io/issues/h-01-settlelongpremium-is-incorrectly-implemented-premium-should-be-deducted-instead-of-added-code4rena-panoptic-panoptic-git)
- [🔴 High - Panoptic - Wrong leg `chunkKey` calculation in `haircutPremia` function](https://solodit.cyfrin.io/issues/m-08-wrong-leg-chunkkey-calculation-in-haircutpremia-function-code4rena-panoptic-panoptic-git)
